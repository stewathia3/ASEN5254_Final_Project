...
def create_rrt(start, goal, obstacles, n, r, epsilon, p_goal, x_lim, y_lim, plot_path):
    ...
    if math.dist(curr_node.point, goal) <= epsilon:
        ...
        if plot_path:
            ...
            ax.text(x_lim[0] + 0.25, y_lim[1] - 0.55, "Path Length: " + str(path_length))
            ax.text(x_lim[1] - 5, y_lim[1] - 0.55, "Tree Size: " + str(len(tree)))
...
if __name__ == '__main__':
    ...
    #-----------------------------------------------------------------------------#
    # Exercise 2 (a): Planning problem of HW2 Exercise 2 (W2)
    #-----------------------------------------------------------------------------#

    start = np.array([0.0,0.0])
    goal = np.array([35.0,0.0])

    # obstacle_tolerance = 0.2

    WO1 = [np.array([-6.0, -6.0]), np.array([25.0, -6.0]), np.array([25.0, -5.0]), np.array([-6.0, -5.0])]
    WO2 = [np.array([-6.0, 5.0]), np.array([30.0, 5.0]), np.array([30.0, 6.0]), np.array([-6.0, 6.0])]
    WO3 = [np.array([-6.0, -5.0]), np.array([-5.0, -5.0]), np.array([-5.0, 5.0]), np.array([-6.0, 5.0])]
    WO4 = [np.array([4.0, -5.0]), np.array([5.0, -5.0]), np.array([5.0, 1.0]), np.array([4.0, 1.0])]
    WO5 = [np.array([9.0, 0.0]), np.array([10.0, 0.0]), np.array([10.0, 5.0]), np.array([9.0, 5.0])]
    WO6 = [np.array([14.0, -5.0]), np.array([15.0, -5.0]), np.array([15.0, 1.0]), np.array([14.0, 1.0])]
    WO7 = [np.array([19.0, 0.0]), np.array([20.0, 0.0]), np.array([20.0, 5.0]), np.array([19.0, 5.0])]
    WO8 = [np.array([24.0, -5.0]), np.array([25.0, -5.0]), np.array([25.0, 1.0]), np.array([24.0, 1.0])]
    WO9 = [np.array([29.0, 0.0]), np.array([30.0, 0.0]), np.array([30.0, 5.0]), np.array([29.0, 5.0])]
    ...
    # plt.savefig('path_lengths_ex2_hw2_ex2_W2.png')
    ...
    # plt.savefig('computation_time_ex2_hw2_ex2_W2.png')
    ...
    # plt.savefig('valid_solutions_ex2_hw2_ex2_W2.png')
