...
if __name__ == '__main__':
    ...
    WO1 = [np.array([3.5, 0.5]), np.array([3.5, 1.5]), np.array([4.5, 1.5]), np.array([4.5, 0.5])]
    WO2 = [np.array([6.5, -1.5]), np.array([6.5, -0.5]), np.array([7.5, -0.5]), np.array([7.5, -1.5])]
    ...
    # plt.savefig('path_lengths_ex2_hw5_ex2a.png')
    ...
    # plt.savefig('computation_time_ex2_hw5_ex2a.png')
    ...
    # plt.savefig('valid_solutions_ex2_hw5_ex2a.png')
